    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let header = {
            let title = Text::new_inline(
                t!("tab_configs_ui.new_worktree.title").to_string(),
                appearance.ui_font_family(),
        ...
        body.add_child(Self::render_section_label(
            t!("tab_configs_ui.new_worktree.select_repository").as_ref(),
            appearance,
        ));
        ...
        body.add_child(
            Container::new(Self::render_section_label(
                t!("tab_configs_ui.new_worktree.select_branch").as_ref(),
                appearance,
            ))
        ...
        let checkbox_row = Flex::row()
            ...
            .with_child(
                Text::new_inline(
                    t!("tab_configs_ui.new_worktree.autogenerate_branch_name").to_string(),
                    appearance.ui_font_family(),
                    appearance.ui_font_size(),
                )
        ...
        if !self.autogenerate_branch_name {
            body.add_child(
                Container::new(Self::render_section_label(
                    t!("tab_configs_ui.new_worktree.worktree_branch_name").as_ref(),
                    appearance,
                ))
                .with_margin_top(SECTION_GAP)
                .finish(),
            ...
            if worktree_name_has_error {
                body.add_child(
                    Container::new(
                        Text::new_inline(
                            t!("tab_configs_ui.new_worktree.invalid_branch_name").to_string(),
                            appearance.ui_font_family(),
                            ERROR_FONT_SIZE,
                        )
        ...
        let cancel_button = appearance
            ...
            .with_text_label(t!("tab_configs_ui.new_worktree.cancel").to_string())
        ...
        let open_button = {
            ...
            let mut builder = appearance
                ...
                .with_text_label(t!("tab_configs_ui.new_worktree.open").to_string())
                .with_style(text_button_base)
                .with_style(UiComponentStyles {
