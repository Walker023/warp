...
pub fn render_agent_shortcuts_view(
    ...
    if !hide_cloud_zero_state_items {
        shortcuts.push(render_shortcut(
            ShortcutProps {
                ...
                text: t!("ai_ui.agent_shortcuts.shell_command"),
                ..Default::default()
            },
            app,
        ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: t!("ai_ui.agent_shortcuts.slash_commands"),
            ..Default::default()
        },
        app,
    ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: t!("ai_ui.agent_shortcuts.attach_context"),
            ..Default::default()
        },
        app,
    ));
    ...
    if !context.is_cloud_agent {
        if let Some(keystroke) = keybinding_name_to_keystroke(TOGGLE_RIGHT_PANEL_BINDING_NAME, app)
        {
            shortcuts.push(render_shortcut(
                ShortcutProps {
                    keystroke,
                    text: t!("ai_ui.agent_shortcuts.open_code_review"),
                    ..Default::default()
                },
                app,
            ));
    ...
    if FeatureFlag::AgentViewConversationListView.is_enabled() {
            ...
            keybinding_name_to_keystroke(TOGGLE_CONVERSATION_LIST_VIEW_BINDING_NAME, app)
        {
            shortcuts.push(render_shortcut(
                ShortcutProps {
                    keystroke,
                    text: t!("ai_ui.agent_shortcuts.toggle_conversation_list"),
                    ..Default::default()
                },
                app,
            ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: t!("ai_ui.agent_shortcuts.search_conversations"),
            ..Default::default()
        },
        app,
    ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: t!("ai_ui.agent_shortcuts.new_conversation"),
            ..Default::default()
        },
        app,
    ));
    ...
    if !hide_cloud_zero_state_items {
            ...
            keybinding_name_to_keystroke(TOGGLE_AUTOEXECUTE_MODE_KEYBINDING, app)
        {
            shortcuts.push(render_shortcut(
                ShortcutProps {
                    keystroke,
                    text: t!("ai_ui.agent_shortcuts.toggle_auto_accept"),
                    ..Default::default()
                },
                app,
            ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: t!("ai_ui.agent_shortcuts.pause_agent"),
            ..Default::default()
        },
        app,
    ));
    ...
    shortcuts.push(render_shortcut(
        ShortcutProps {
            ...
            text: t!("ai_ui.agent_shortcuts.back_to_terminal"),
            ..Default::default()
        },
        app,
    ));
