    ...
    fn render_text_column(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let title = ui_builder
            .span(if self.visibility_state == VisibilityState::Speedbump {
                t!("ai_ui.codebase_index_banner.title").to_string()
            } else {
                t!("ai_ui.codebase_index_banner.indexing_title").to_string()
            })
        ...
        let body = ui_builder
            .span(t!("ai_ui.codebase_index_banner.description").to_string())
            .with_style(UiComponentStyles {
    ...
    pub fn render_codebase_index_speedbump_banner(
        ...
        if self.visibility_state == VisibilityState::Speedbump {
            ...
            let checkbox_text = ui_builder
                .span(t!("ai_ui.codebase_index_banner.allow_automatic").to_string())
                .with_style(UiComponentStyles {
                    ...
                    Container::new(
                        Align::new(
                            ui_builder
                                ...
                                .with_text_label(
                                    t!("ai_ui.codebase_index_banner.index_codebase").to_string(),
                                )
                                .with_style(UiComponentStyles {
                                    font_color: Some(appearance.theme().foreground().into_solid()),
                                    font_size: Some(appearance.ui_font_size()),
                    ...
                    Container::new(
                        Align::new(
                            ui_builder
                                ...
                                .with_text_label(
                                    t!("ai_ui.codebase_index_banner.view_status").to_string(),
                                )
                                .with_style(UiComponentStyles {
                                    font_color: Some(appearance.theme().foreground().into_solid()),
                                    font_size: Some(appearance.ui_font_size()),
