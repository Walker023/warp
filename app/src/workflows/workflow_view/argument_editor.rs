                    ...
                    .for_each(|(index, argument)| {
                            ...
                            || !argument.name.eq(&self.arguments_rows[index].name)
                        {
                            let description_editor = Self::create_editor_handle(
                                ...
                                Some(ui_font_family),
                                Some(t!("workflows_ui.arguments.description_placeholder").as_ref()),
                            ...
                            let default_value_editor = Self::create_editor_handle(
                                ...
                                Some(ui_font_family),
                                Some(
                                    t!("workflows_ui.arguments.default_value_placeholder").as_ref(),
                                ),
                                false, /* vim_keybindings */
                                true,
                                false,
    ...
    fn render_arguments_section_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        arguments_section_row.add_child(
            Shrinkable::new(
                ...
                self.render_section_header(
                    t!("workflows_ui.arguments.heading").to_string(),
                    appearance,
                ),
            )
            .finish(),
        ...
        if self.is_editable() {
            ...
            arguments_section_row.add_child(
                ...
                .with_tooltip(move || {
                    ui_builder
                        .tool_tip(t!("workflows_ui.arguments.add_tooltip").to_string())
                        .build()
                        .finish()
                })
                .build()
            ...
            arguments_section_row.add_child(
                Shrinkable::new(
                    ...
                    Container::new(
                        appearance
                            .ui_builder()
                            .span(t!("workflows_ui.arguments.viewer_help").to_string())
                            .with_soft_wrap()
    ...
    fn render_alias_arguments(
        ...
        for (index, argument) in self.arguments_state.arguments.iter().enumerate() {
            ...
            if current_description.is_empty() {
                current_description
                    .push_str(t!("workflows_ui.arguments.value_placeholder").as_ref());
    ...
    fn render_env_vars_selector(
        ...
        let action_element = if self.env_vars_selector.as_ref(app).has_env_vars(app) {
            ...
            appearance
                ...
                .with_centered_text_label(
                    t!("workflows_ui.arguments.add_environment_variables").to_string(),
                )
                .build()
                .on_click(|ctx, _, _| {
        ...
        Flex::row()
            .with_children([
                appearance
                    .ui_builder()
                    .span(t!("workflows_ui.arguments.environment_variables").to_string())
                    .with_style(UiComponentStyles {
                        font_size: Some(13.),
                        ..Default::default()
                    })
