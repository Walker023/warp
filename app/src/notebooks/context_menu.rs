    ...
    V::Action: Clone + From<ContextMenuAction>,
{
    ...
    pub fn show_context_menu(&mut self, source: MenuSource, ctx: &mut ViewContext<V>) {
        ...
        if has_selection && can_edit {
            let item = MenuItemFields::new(t!("notebooks.context_menu.cut"))
        ...
        if has_selection {
            let item = MenuItemFields::new(t!("notebooks.context_menu.copy"))
        ...
        if can_edit {
            let item = MenuItemFields::new(t!("notebooks.context_menu.paste"))
    ...
    fn split_pane_menu_items(&self, ctx: &mut ViewContext<V>) -> Vec<MenuItem<V::Action>> {
        ...
        if ContextFlag::CreateNewSession.is_enabled() {
            items.extend([
                MenuItemFields::new(t!("notebooks.context_menu.split_right"))
                    ...
                    .into_item(),
                MenuItemFields::new(t!("notebooks.context_menu.split_left"))
                    .with_on_select_action(V::Action::from(ContextMenuAction::EmitPaneEvent(
                    ...
                    .into_item(),
                MenuItemFields::new(t!("notebooks.context_menu.split_down"))
                    .with_on_select_action(V::Action::from(ContextMenuAction::EmitPaneEvent(
                    ...
                    .into_item(),
                MenuItemFields::new(t!("notebooks.context_menu.split_up"))
                    .with_on_select_action(V::Action::from(ContextMenuAction::EmitPaneEvent(
        ...
        if split_pane_state.is_in_split_pane() {
            ...
            items.push(
                MenuItemFields::new(t!("notebooks.context_menu.close_pane"))
                    .with_on_select_action(V::Action::from(ContextMenuAction::EmitPaneEvent(
                        PaneEvent::Close,
                    )))
