    ...
    fn render_hint_text(&self, appearance: &Appearance) -> Box<dyn Element> {
        let hint_text = match self {
            ThemeChooserMode::SystemAgnostic => appearance
                .ui_builder()
                .paragraph(t!("common_extra.themes.current_hint").to_string()),
            ThemeChooserMode::SystemLight => appearance
                .ui_builder()
                .paragraph(t!("common_extra.themes.light_hint").to_string()),
            ThemeChooserMode::SystemDark => appearance
                .ui_builder()
                .paragraph(t!("common_extra.themes.dark_hint").to_string()),
        };
        hint_text
            .build()
            ...
            .with_child(
                Shrinkable::new(
                    ...
                    Align::new(
                        appearance
                            .ui_builder()
                            .span(t!("common_extra.themes.title").to_string())
        ...
        let element = if list_len == 0 {
            ...
            Flex::column()
                .with_child(
                    appearance
                        .ui_builder()
                        .span(t!("common_extra.themes.no_matches").to_string())
                        .build()
                        .finish(),
                )
...
impl View for ThemeChooser {
    ...
    fn accessibility_contents(&self, _: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new(
            t!("common_extra.themes.a11y.description").to_string(),
            t!("common_extra.themes.a11y.close_help").to_string(),
