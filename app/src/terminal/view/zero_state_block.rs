...
impl View for TerminalViewZeroStateBlock {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let title = Flex::row()
            ...
            .with_child(
                Text::new(
                    t!("terminal.zero_state.new_terminal_session").to_string(),
            ...
            render_standard_message(
                Message::new(vec![MessageItem::clickable(
                    vec![
                        ...
                        MessageItem::text(
                            t!("terminal.zero_state.start_agent_conversation").to_string(),
                        ),
                    ],
                    |ctx| {
            ...
            render_standard_message(
                Message::new(vec![MessageItem::clickable(
                    vec![
                        ...
                        MessageItem::text(
                            t!("terminal.zero_state.start_cloud_agent_conversation").to_string(),
                        ),
                    ],
                    |ctx| {
            ...
            render_standard_message(
                Message::new(vec![MessageItem::clickable(
                    vec![
                        ...
                        MessageItem::text(
                            t!("terminal.zero_state.cycle_past_commands_and_conversations")
                                .to_string(),
                        ),
                    ],
                    |ctx| {
                ...
                items.push(render_standard_message(
                    Message::new(vec![MessageItem::clickable(
                        vec![
                            MessageItem::keystroke(keystroke),
                            MessageItem::text(
                                t!("terminal.zero_state.open_code_review").to_string(),
                            ),
                        ],
                        |ctx| {
                ...
                Flex::row()
                    ...
                    .with_child(
                        Shrinkable::new(
                            ...
                            render_standard_message(
                                Message::from_text(
                                    t!("terminal.zero_state.autodetect_agent_prompts").to_string(),
                                ),
                                app,
                            ),
                        )
