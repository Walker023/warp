...
pub fn render_aws_bedrock_login_banner(
    ...
    let buttons = vec![
        InlineBannerTextButton {
            text: t!("common.dont_show_again").to_string(),
        ...
        InlineBannerTextButton {
            text: t!("terminal_ui.inline_banner.aws_bedrock.log_in").to_string(),
            text_color: active_ui_text_color,
            button_state: InlineBannerButtonState {
                on_click_event: TerminalAction::AwsBedrockLoginBanner(
    ...
    let description_text = warpui::elements::Text::new(
        t!("terminal_ui.inline_banner.aws_bedrock.description").to_string(),
    ...
    render_inline_block_list_banner(
        ...
        appearance,
        InlineBannerContent {
            title: t!("terminal_ui.inline_banner.aws_bedrock.title").to_string(),
