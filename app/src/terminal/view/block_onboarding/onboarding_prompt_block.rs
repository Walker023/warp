...
impl OnboardingPromptBlock {
    ...
    fn render_text(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Flex::column()
            .with_children([
                Container::new(
                    Text::new(
                        t!("terminal_ui.onboarding.prompt.description").to_string(),
                        font_family,
                        font_size,
                    )
                    ...
                    FormattedTextElement::new(
                        FormattedText::new([FormattedTextLine::Line(vec![
                            FormattedTextFragment::plain_text(
                                t!("terminal_ui.onboarding.prompt.compatibility").to_string(),
                            ),
    ...
    fn render_existing_prompt_button_interior(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let prompt_body = if let Some((grid, size_info)) = &self.ps1_grid_info {
            ...
            Text::new_inline(
                t!("terminal_ui.onboarding.prompt.no_existing").to_string(),
                font_family,
                font_size,
            )
            .with_color(font_color.into_solid())
        ...
        Flex::column()
            .with_child(
                Container::new(
                    Text::new_inline(
                        t!("terminal_ui.onboarding.prompt.shell_title").to_string(),
                        font_family,
                        font_size,
                    )
                    .with_color(font_color.into_solid())
                ...
                Shrinkable::new(
                    ...
                    Align::new(
                        Flex::row()
                            .with_children([
                                Text::new_inline(
                                    t!("terminal_ui.onboarding.prompt.incorrect").to_string(),
                                    font_family,
                                    font_size,
                                )
                                .with_color(
                                ...
                                appearance
                                    .ui_builder()
                                    .link(
                                        t!("terminal_ui.onboarding.prompt.report").to_string(),
    ...
    fn render_warp_prompt_button_interior(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Flex::column()
            .with_child(
                Container::new(
                    Text::new_inline(
                        t!("terminal_ui.onboarding.prompt.warp_title").to_string(),
                        font_family,
            ...
            .with_child(
                Shrinkable::new(
                    ...
                    Align::new(
                        Text::new_inline(
                            t!("terminal_ui.onboarding.prompt.customizable").to_string(),
                            font_family,
                            ui_font_size,
                        )
