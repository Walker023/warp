    ...
    A: Action + Clone,
{
    ...
    let text = t!("auth_extra.offline.summary").to_string();
    ...
    let button = ui_builder
        ...
        .with_centered_text_label(t!("auth_extra.offline.learn_more").to_string())
        .build()
    ...
    A: Action + Clone,
{
    ...
    let paragraph_1 = t!("auth_extra.offline.non_cloud_features").to_string();
    let paragraph_2 = t!("auth_extra.offline.first_use").to_string();
    let paragraph_3 = t!("auth_extra.offline.cloud_features").to_string();
        ...
        Flex::column()
            ...
            .with_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .span(t!("auth_extra.offline.title").to_string())
            ...
            .with_child(render_close_overlay_button(
                ...
                t!("auth_extra.offline.dismiss").to_string(),
                mouse_state_handle,
                action,
            ))
            .finish(),
    ...
    Container::new(
        Flex::column()
            ...
            .with_child(
                Container::new(
                    ui_builder
                        .span(t!("auth_extra.privacy.title").to_string())
                        .with_style(header_styles)
                        .build()
                        .finish(),
                )
            ...
            .with_child(render_close_overlay_button(
                appearance,
                ui_builder,
                t!("auth_extra.privacy.done").to_string(),
...
pub fn render_privacy_settings_toggles<A: Action + Clone + 'static>(
        ...
        .with_child(
            Shrinkable::new(
                ...
                render_privacy_settings_section_header(
                    t!("auth_extra.privacy.improve_warp").to_string(),
                    appearance,
                )
                .finish(),
            )
    ...
    let telemetry_description = render_description(
        appearance,
        t!("auth_extra.privacy.usage_description").to_string(),
    );
    ...
    let telemetry_link = Flex::row()
        .with_child(
            appearance
                .ui_builder()
                .link(
                    t!("auth_extra.privacy.learn_more").to_string(),
    ...
    let crash_reporting_toggle = Flex::row()
        ...
        .with_child(
            Shrinkable::new(
                1.,
                render_privacy_settings_section_header(
                    t!("auth_extra.privacy.crash_reports").to_string(),
                    appearance,
                )
                .finish(),
            )
    ...
    let crash_reporting_description = render_description(
        appearance,
        t!("auth_extra.privacy.crash_description").to_string(),
    );
    ...
    let cloud_conversation_storage_toggle = Flex::row()
        ...
        .with_child(
            Shrinkable::new(
                1.,
                render_privacy_settings_section_header(
                    t!("auth_extra.privacy.cloud_conversations").to_string(),
                    appearance,
                )
                .finish(),
            )
    ...
    let cloud_conversation_storage_description = render_description(
        ...
        if PrivacySettings::as_ref(app).is_cloud_conversation_storage_enabled {
            t!("auth_extra.privacy.cloud_enabled_description").to_string()
        } else {
            t!("auth_extra.privacy.cloud_disabled_description").to_string()
        },
    );
