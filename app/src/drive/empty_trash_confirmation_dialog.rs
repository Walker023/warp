...
impl View for EmptyTrashConfirmationDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let confirm_button = appearance
            ...
            .with_centered_text_label(t!("drive_extra.dialogs.empty_trash.confirm").to_string())
        ...
        let cancel_button = appearance
            ...
            .with_centered_text_label(t!("drive_extra.common.cancel").to_string())
            .with_style(button_style)
            .build()
            .with_cursor(Cursor::PointingHand)
            .on_click(move |ctx, _, _| {
        ...
        Dialog::new(
            t!("drive_extra.dialogs.empty_trash.title").to_string(),
            Some(t!("drive_extra.dialogs.empty_trash.body").to_string()),
            UiComponentStyles {
                width: Some(460.),
