...
impl CloudActionConfirmationDialog {
    ...
    fn title_text(&self) -> String {
        match self.variant {
            ...
            | CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => {
                t!("drive_extra.dialogs.team_action.leave_title").to_string()
            }
            CloudActionConfirmationDialogVariant::DeleteTeam => {
                t!("drive_extra.dialogs.team_action.delete_title").to_string()
            }
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                t!("drive_extra.dialogs.team_action.remove_member_title").to_string()
            }
    ...
    fn body_text(&self) -> String {
        match self.variant {
            CloudActionConfirmationDialogVariant::LeaveTeam => {
                t!("drive_extra.dialogs.team_action.leave_body").to_string()
            }
            CloudActionConfirmationDialogVariant::DeleteTeam => {
                t!("drive_extra.dialogs.team_action.delete_body").to_string()
            }
            CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => {
                t!("drive_extra.dialogs.team_action.leave_reload_credits_body").to_string()
            }
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                t!("drive_extra.dialogs.team_action.remove_member_reload_credits_body").to_string()
            }
            CloudActionConfirmationDialogVariant::None => String::new(),
        }
    }
    ...
    fn confirm_button_text(&self) -> String {
        match self.variant {
            CloudActionConfirmationDialogVariant::LeaveTeam => {
                t!("drive_extra.dialogs.team_action.confirm_leave").to_string()
            }
            CloudActionConfirmationDialogVariant::DeleteTeam => {
                t!("drive_extra.dialogs.team_action.confirm_delete").to_string()
            }
            CloudActionConfirmationDialogVariant::LeaveTeamReloadCredits => {
                t!("drive_extra.dialogs.team_action.leave_team").to_string()
            }
            CloudActionConfirmationDialogVariant::RemoveTeamMemberReloadCredits => {
                t!("drive_extra.dialogs.team_action.remove_member").to_string()
            }
            CloudActionConfirmationDialogVariant::None => String::new(),
        }
    }
