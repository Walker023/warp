...
impl PrivacyPageView {
    ...
    pub fn new(ctx: &mut ViewContext<PrivacyPageView>) -> Self {
        ...
        let add_regex_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(t!("settings.privacy_page.add_regex_pattern").to_string()),
                add_regex_body,
                ctx,
            )
    ...
    fn build_page() -> PageType<Self> {
        ...
        PageType::new_uncategorized(widgets, Some(&*t!("settings.sections.privacy")))
    }
    ...
    fn add_custom_regex(&mut self, name: String, pattern: String, ctx: &mut ViewContext<Self>) {
        ...
        ctx.update_model(&privacy_settings_handle, |privacy_settings, ctx| {
            if let Ok(regex) = Regex::new(&pattern) {
                ...
                report_error!("Invalid regex pattern", extra: { "pattern" => %pattern });
            }
        });
    }
...
impl SecretRedactionWidget {
    ...
    fn render_tab_bar(
        ...
        let personal_tab = self.render_tab(
            t!("settings.privacy_page.personal").to_string(),
            personal_count,
        ...
        let enterprise_tab = self.render_tab(
            t!("settings.privacy_page.enterprise").to_string(),
            enterprise_count,
        ...
        if is_enterprise_tab_active {
            ...
            row.add_child(self.render_info(
                t!("settings.privacy_page.enterprise_redaction_locked").to_string(),
                appearance,
            ));
        }
    ...
    fn render_enterprise_content(
        ...
        if enterprise_regex_list.is_empty() {
            return ui_builder
                .paragraph(t!("settings.privacy_page.no_enterprise_regexes").to_string())
                .with_style(UiComponentStyles {
                    font_color: Some(description_text_color),
                    ..Default::default()
                })
                            ...
                            Container::new(
                                ui_builder
                                    ...
                                    .with_text_and_icon_label(Self::add_button(
                                        t!("settings.privacy_page.add_all").to_string(),
                                        appearance,
                                    ))
...
impl SettingsWidget for SecretRedactionWidget {
    ...
    fn render(
            ...
            Flex::row()
                .with_child(
                    Shrinkable::new(
                        ...
                        render_sub_header(
                            appearance,
                            t!("settings.privacy_page.secret_redaction").to_string(),
                ...
                .with_child(
                    Container::new({
                        if is_enterprise_enabled {
                            self.render_info(
                                t!("settings.privacy_page.enabled_by_organization").to_string(),
                                appearance,
                            )
                        } else {
                            ui_builder
        ...
        let mut column = Flex::column()
            ...
            .with_child(
                ui_builder
                    .paragraph(t!("settings.privacy_page.secret_redaction_description").to_string())
                    .with_style(UiComponentStyles {
                        font_color: Some(description_text_color),
        ...
        if *safe_mode_settings.safe_mode_enabled {
            ...
            let label_with_icon = super::settings_page::render_dropdown_item_label(
                t!("settings.privacy_page.secret_visual_redaction_mode").to_string(),
                None,
            ...
            let left_content = Flex::column()
                ...
                .with_child(
                    Container::new(
                        ui_builder
                            .paragraph(
                                t!("settings.privacy_page.secret_visual_redaction_description")
                                    .to_string(),
                            )
                            .with_style(UiComponentStyles {
                                font_color: Some(description_text_color),
                ...
                Flex::row()
                    ...
                    .with_child(
                        Expanded::new(
                            ...
                            Flex::column()
                                .with_child(self.render_section_title(
                                    t!("settings.privacy_page.custom_secret_redaction").to_string(),
                                    appearance,
                                ))
                                .with_child(self.render_description(
                                    t!("settings.privacy_page.custom_secret_redaction_description")
                                        .to_string(),
                                    appearance,
                    ...
                    .with_child(
                        ui_builder
                            ...
                            .with_text_and_icon_label(Self::add_button(
                                t!("settings.privacy_page.add_regex").to_string(),
                                appearance,
                            ))
                            .with_style(Self::add_button_style())
                            .build()
...
impl AppAnalyticsWidget {
    fn render_zero_data_retention_badge(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Hoverable::new(self.zdr_badge_mouse_state.clone(), move |mouse_state| {
            ...
            if is_hovered {
                let tooltip =
                    ui_builder.tool_tip(t!("settings.privacy_page.zdr_tooltip").to_string());
...
impl SettingsWidget for AppAnalyticsWidget {
    ...
    fn render(
        ...
        let description = if is_enterprise {
            t!("settings.privacy_page.telemetry_description_old").to_string()
        } else {
            t!("settings.privacy_page.telemetry_description").to_string()
        };
        ...
        let zdr_label_component = if self.should_show_zdr_badge(app) {
            Flex::row()
                ...
                .with_child(render_body_item_label::<PrivacyPageAction>(
                    t!("settings.privacy_page.help_improve_warp").to_string(),
                    None,
                    None,
        ...
        let switch = if is_toggleable {
            ...
            switch
                .with_tooltip(TooltipConfig {
                    text: t!("settings.privacy_page.managed_by_organization").to_string(),
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        t!("settings.privacy_page.read_more_data_use").to_string(),
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                t!("settings.privacy_page.send_crash_reports").to_string(),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(t!("settings.privacy_page.crash_reports_description").to_string())
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
...
impl SettingsWidget for CloudConversationStorageWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                t!("settings.privacy_page.store_ai_conversations_cloud").to_string(),
                None,
                LocalOnlyIconState::Hidden,
                toggle_state,
                appearance,
...
impl SettingsWidget for NetworkLogWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                t!("settings.privacy_page.network_log_console").to_string(),
                None,
            ...
            .with_child(
                Align::new(
                    ui_builder
                        .link(
                            t!("settings.privacy_page.view_network_logging").to_string(),
                            None,
                            Some(Box::new(|ctx| {
...
impl SettingsWidget for DataManagementWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                t!("settings.privacy_page.manage_your_data").to_string(),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                ui_builder
                    .paragraph(t!("settings.privacy_page.data_management_description").to_string())
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            t!("settings.privacy_page.data_management_link").to_string(),
                            None,
                            Some(Box::new(|ctx| {
                                ctx.dispatch_typed_action(
                                    PrivacyPageAction::OpenDataManagementWebpage,
...
impl SettingsWidget for PrivacyPolicyWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                t!("settings.privacy_page.privacy_policy").to_string(),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            t!("settings.privacy_page.privacy_policy_link").to_string(),
