    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::custom(
            SettingActionPairDescriptions::new(
                t!("settings.warp_drive.enable"),
                t!("settings.warp_drive.disable"),
            ),
...
impl SettingsWidget for WarpDriveHeaderWidget {
    ...
    fn render(
        ...
        let message = Container::new(
            Text::new_inline(
                t!("settings.warp_drive.sign_up_prompt").to_string(),
...
impl SettingsWidget for WarpDriveToggleWidget {
    ...
    fn render(
        ...
        render_body_item::<WarpDriveSettingsPageAction>(
            t!("settings.sections.warp_drive").to_string(),
            Some(AdditionalInfo {
            ...
            appearance
                ...
                .finish(),
            Some(t!("settings.warp_drive.description").to_string()),
        )
    }
}
