...
pub fn search_placeholder() -> String {
    t!("settings.keybindings.search_placeholder").to_string()
}
...
impl KeybindingRow {
    ...
    fn render_clicked(
        ...
        let conflict_warning = if has_conflicting_binding {
            render_text(
                &t!("settings.keybindings.shortcut_conflict_warning"),
        ...
        let press_new_shortcut_text = render_text(
            &t!("settings.keybindings.press_new_shortcut"),
            None,
            appearance,
        );
        ...
        let cancel = Container::new(
            Hoverable::new(
                ...
                |state| {
                    ...
                    if index == 0 {
                        SavePosition::new(
                            render_button(&t!("common.cancel"), appearance, cancel_button_color),
                ...
                Wrap::row()
                    .with_child(
                        Container::new(render_text(
                            &t!("settings.keybindings.use_shortcut_prefix"),
                            Some(UiComponentStyles {
                                font_size: Some(font_size),
                                font_color: Some(
                                    appearance
                    ...
                    .with_child(
                        Container::new(render_text(
                            &t!("settings.keybindings.use_shortcut_suffix"),
                            Some(UiComponentStyles {
                                font_size: Some(font_size),
                                font_color: Some(
                                    appearance
    ...
    fn render(
        ...
        let local_only_icon_state = if *CloudPreferencesSettings::as_ref(app).settings_sync_enabled
        {
            Some(LocalOnlyIconState::Visible {
                ...
                custom_tooltip: Some(t!("settings.keybindings.local_only_tooltip").to_string()),
            })
        } else {
            None
        };
        ...
        let subheader = render_sub_header(
            appearance,
            t!("settings.keybindings.configure_shortcuts").to_string(),
        ...
        Flex::column()
            ...
            .with_child(render_columns(
                Container::new(render_text(
                    &t!("settings.keybindings.command_column"),
                    Some(UiComponentStyles {
