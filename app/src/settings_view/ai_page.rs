...
fn action_permission_description(permission: ActionPermission) -> String {
    match permission {
        ActionPermission::AgentDecides | ActionPermission::Unknown => {
            t!("settings.execution_profile.agent_decides_description").to_string()
        }
        ActionPermission::AlwaysAllow => {
            t!("settings.execution_profile.always_allow_description").to_string()
        }
        ActionPermission::AlwaysAsk => {
            t!("settings.execution_profile.always_ask_description").to_string()
        }
    }
}
...
fn write_to_pty_permission_description(permission: WriteToPtyPermission) -> String {
    match permission {
        ...
        WriteToPtyPermission::AskOnFirstWrite => {
            t!("settings.execution_profile.ask_on_first_write_description").to_string()
        }
        WriteToPtyPermission::AlwaysAsk => {
            t!("settings.execution_profile.write_to_pty_always_ask_description").to_string()
        }
...
pub fn init_actions_from_parent_view<T: Action + Clone>(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            if FeatureFlag::AgentView.is_enabled() {
                t!("settings.ai.input.terminal_command_autodetection").to_string()
            } else {
                t!("settings.ai.input.natural_language_detection_command").to_string()
            },
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            t!("settings.ai.input.agent_prompt_autodetection"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            t!("settings.ai.active_ai.next_command"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            t!("settings.ai.active_ai.prompt_suggestions"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            t!("settings.ai.input.code_suggestions"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::custom(
            SettingActionPairDescriptions::new(
                t!("settings.ai.input.show_agent_tips_command").to_string(),
                t!("settings.ai.input.hide_agent_tips_command").to_string(),
            ),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::custom(
            SettingActionPairDescriptions::new(
                t!("settings.ai.input.show_oz_changelog").to_string(),
                t!("settings.ai.input.hide_oz_changelog").to_string(),
            ),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            t!("settings.ai.active_ai.natural_language_autosuggestions_command"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            t!("settings.ai.active_ai.shared_block_title_generation_command"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            t!("settings.ai.active_ai.commit_pr_generation_command"),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::new(
            t!("settings.ai.input.voice_input"),
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![ToggleSettingActionPair::custom(
            SettingActionPairDescriptions::new(
                t!("settings.ai.input.show_use_agent_footer").to_string(),
                t!("settings.ai.input.hide_use_agent_footer").to_string(),
            ),
            builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![
            ToggleSettingActionPair::new(
                t!("settings.ai.input.include_agent_commands_in_history"),
                builder(SettingsAction::AI(
            ...
            .with_group(bindings::BindingGroup::WarpAi),
            ToggleSettingActionPair::new(
                t!("settings.ai.input.conversation_history_tools_panel"),
                builder(SettingsAction::AI(
            ...
            .with_group(bindings::BindingGroup::WarpAi),
            ToggleSettingActionPair::new(
                t!("settings.ai.input.model_picker_in_prompt"),
                builder(SettingsAction::AI(
            ...
            .with_group(bindings::BindingGroup::WarpAi),
            ToggleSettingActionPair::new(
                t!("settings.ai.input.coding_agent_toolbar"),
                builder(SettingsAction::AI(
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![
            ...
            ToggleSettingActionPair::new(
                t!("settings.ai.knowledge.suggested_rules"),
                builder(SettingsAction::AI(
            ...
            ToggleSettingActionPair::new(
                t!("settings.ai.knowledge.warp_drive_context"),
                builder(SettingsAction::AI(
            ...
            .with_enabled(|| FeatureFlag::AIRules.is_enabled()),
            ToggleSettingActionPair::new(
                t!("settings.ai.mcp_servers.auto_spawn_from_third_party"),
    ...
    ToggleSettingActionPair::add_toggle_setting_action_pairs_as_bindings(
        vec![
            ToggleSettingActionPair::new(
                t!("settings.ai.custom_inference.warp_credit_fallback"),
                builder(SettingsAction::AI(
...
impl AISettingsPageView {
    pub fn new(ctx: &mut ViewContext<Self>) -> Self {
        ...
        let code_read_allowlist_editor = ctx.add_typed_action_view(|ctx| {
            ...
            input.set_placeholder_text(
                t!("settings.execution_profile.directory_allowlist_placeholder"),
                ctx,
            );
            input
        });
        ...
        let autodetection_denylist_editor = ctx.add_typed_action_view(|ctx| {
            ...
            editor.set_placeholder_text(
                t!("settings.ai.input.commands_comma_separated_placeholder"),
                ctx,
            );
        ...
        let command_execution_allowlist_editor = ctx.add_typed_action_view(|ctx| {
            ...
            input.set_placeholder_text(
                t!("settings.execution_profile.command_allowlist_placeholder"),
                ctx,
            );
            input
        });
        ...
        let cli_agent_footer_command_editor = ctx.add_typed_action_view(|ctx| {
            let mut input =
                SubmittableTextInput::new(ctx).validate_on_edit(|s| Regex::new(s).is_ok());
            input.set_placeholder_text(
                t!("settings.ai.third_party_cli_agents.command_regex_placeholder"),
                ctx,
            );
            input
        });
        ...
        let write_to_pty_autonomy_dropdown_menu = ctx.add_typed_action_view(|ctx| {
            ...
            dropdown.set_items(
                vec![
                    ...
                    DropdownItem::new(
                        t!("settings.execution_profile.ask_on_first_write"),
        ...
        let mcp_allowlist_dropdown = ctx.add_typed_action_view(|ctx| {
            ...
            dropdown.set_top_bar_max_width(AI_SETTINGS_DROPDOWN_WIDTH);
            dropdown.set_menu_width(AI_SETTINGS_DROPDOWN_WIDTH, ctx);
            dropdown.set_menu_header_to_static(t!("settings.execution_profile.select_mcp_servers"));
            dropdown
        });
        ...
        let command_denylist_editor = ctx.add_typed_action_view(|ctx| {
            let mut input =
                SubmittableTextInput::new(ctx).validate_on_edit(|s| Regex::new(s).is_ok());
            input.set_placeholder_text(
                t!("settings.execution_profile.command_denylist_placeholder"),
                ctx,
            );
            input
        });
        ...
        let add_router_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(
                t!("settings.ai.buttons.add_router").to_string(),
                SecondaryTheme,
            )
        ...
        let add_profile_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(
                t!("settings.ai.buttons.add_profile").to_string(),
                SecondaryTheme,
            )
            .with_icon(Icon::Plus)
            .with_size(ButtonSize::Small)
        ...
        let custom_inference_add_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(
                t!("settings.ai.buttons.add_custom_model").to_string(),
                SecondaryTheme,
            )
            .with_size(ButtonSize::Small)
            .on_click(|ctx| {
        ...
        let custom_endpoint_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(t!("settings_extra.ai.add_custom_endpoint").to_string()),
        ...
        let set_default_model_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(t!("settings_extra.ai.change_default_model_title").to_string()),
        ...
        let conversation_layout_dropdown = ctx.add_typed_action_view(|ctx| {
            ...
            let new_tab_label = t!("settings_extra.features.new_tab").to_string();
            let split_pane_label = t!("settings_extra.features.split_pane").to_string();
            let items = vec![
                DropdownItem::new(
                    new_tab_label.clone(),
            ...
            SetDefaultModelModalBodyEvent::SetDefault(id) => {
                ...
                crate::ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = crate::view_components::DismissibleToast::success(
                        t!("settings_extra.ai.default_model_updated").to_string(),
                    );
    ...
    fn maybe_prompt_set_default_model_for_provider(
        ...
        let description = t!(
            "settings_extra.ai.provider_api_key_default_model_description",
    ...
    fn maybe_prompt_set_default_model_for_custom_endpoint(
        ...
        let description = format!(
            "{}{}",
            t!(
                "settings_extra.ai.custom_endpoint_default_model_intro",
                name = endpoint.name
            ),
            t!(
                "settings_extra.ai.custom_endpoint_default_model_question",
        ...
        (0..count)
            .map(|index| {
                let button = ctx.add_typed_action_view(move |_| {
                    ActionButton::new(t!("common.edit").to_string(), SecondaryTheme)
    ...
    fn show_edit_custom_endpoint_modal(&mut self, index: usize, ctx: &mut ViewContext<Self>) {
        ...
        self.custom_endpoint_modal_state.set_title(
            Some(t!("settings_extra.ai.edit_custom_endpoint").to_string()),
            ctx,
        );
    ...
    fn handle_custom_endpoint_modal_event(
        ...
        match event {
            ...
            CustomEndpointModalEvent::AddEndpoint {
                ...
                crate::ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = crate::view_components::DismissibleToast::success(
                        t!("settings_extra.ai.endpoint_added").to_string(),
                    );
                    toast_stack.add_ephemeral_toast(toast, window_id, ctx);
                });
            ...
            CustomEndpointModalEvent::SaveEndpoint {
                ...
                crate::ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = crate::view_components::DismissibleToast::success(
                        t!("settings_extra.ai.endpoint_saved").to_string(),
                    );
                    toast_stack.add_ephemeral_toast(toast, window_id, ctx);
                });
    ...
    fn handle_remove_custom_endpoint_confirmation_dialog_event(
        ...
        match event {
            ...
            RemoveCustomEndpointConfirmationDialogEvent::Confirm(index) => {
                ...
                crate::ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = crate::view_components::DismissibleToast::success(
                        t!("settings_extra.ai.endpoint_removed").to_string(),
                    );
                    toast_stack.add_ephemeral_toast(toast, window_id, ctx);
                });
                ctx.notify();
    ...
    fn create_grok_code_editor(ctx: &mut ViewContext<Self>) -> ViewHandle<EditorView> {
        ctx.add_typed_action_view(|ctx| {
            ...
            let mut editor = EditorView::single_line(options, ctx);
            editor.set_placeholder_text(t!("settings.ai.grok.paste_sign_in_code").to_string(), ctx);
            editor
        })
    }
    ...
    fn start_grok_oauth(&mut self, ctx: &mut ViewContext<Self>) {
            ...
            Err(err) => {
                ...
                ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = DismissibleToast::error(
                        t!("settings_extra.ai.grok_login_start_failed", name = err).to_string(),
                    );
                    toast_stack.add_ephemeral_toast(toast, window_id, ctx);
                });
                return;
        ...
        ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
            ...
            let toast = DismissibleToast::default(
                t!("settings_extra.ai.opening_supergrok_browser").to_string(),
            )
            .with_object_id(CONNECT_TOAST_OBJECT_ID.to_string())
            .with_link(
                ToastLink::new(t!("settings_extra.ai.copy_url").to_string())
            ...
            let toast = match result {
                Ok(tokens) => {
                    ...
                    DismissibleToast::success(
                        t!("settings_extra.ai.supergrok_connected").to_string(),
                    )
                }
                Err(err) => {
                    me.grok_oauth_attempt = None;
                    ...
                    DismissibleToast::error(
                        t!("settings_extra.ai.supergrok_connect_failed", name = err).to_string(),
                    )
                }
            };
            ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
            ...
            |me, result, ctx| {
                ...
                let toast = match result {
                    ...
                    Err(err) => {
                        ...
                        DismissibleToast::error(
                            t!("settings_extra.ai.supergrok_connect_failed", name = err)
                                .to_string(),
                        )
                    }
                };
    ...
    fn refresh_autonomy_dropdown_menu(
        ...
        menu.update(ctx, |menu, ctx| {
            ...
            menu.set_items(
                vec![
                    DropdownItem::new(
                        t!("settings_extra.ai.autonomy_read_only").to_string(),
                        AISettingsPageAction::SetAutonomyReadonlyCommandsSetting,
                    ),
                    DropdownItem::new(
                        t!("settings_extra.ai.autonomy_supervised").to_string(),
                    ...
                    .map(|t| {
                        let display = match t {
                            ...
                            AgentModeCodingPermissionsType::AllowReadingSpecificFiles => {
                                t!("settings.execution_profile.allow_in_specific_directories")
                            }
                        };
        ...
        entries
            ...
            .map(|(pattern_clone, current_agent)| {
                ctx.add_typed_action_view(move |ctx| {
                    ...
                    let other_label = t!("settings_extra.ai.other_coding_agent").to_string();
                    items.push(
                    ...
                    let other_label_for_header = other_label.clone();
                    dropdown.set_menu_header_text_override(move |label| {
                        if label == other_label_for_header {
                            t!("settings_extra.ai.select_coding_agent").to_string()
                        } else {
                            label.to_string()
                        }
                    });
            ...
            AISettingsPageAction::DisconnectGrokSubscription => {
                ...
                crate::ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = crate::view_components::DismissibleToast::default(
                        t!("settings_extra.ai.supergrok_disconnected").to_string(),
                    );
                    toast_stack.add_ephemeral_toast(toast, window_id, ctx);
                });
                ctx.notify();
...
fn render_toolbar_layout_editor(
    ...
    let label = Container::new(
        appearance
            .ui_builder()
            .span(t!("settings_extra.ai.toolbar_layout").to_string())
            .with_style(UiComponentStyles {
...
impl SettingsWidget for GlobalAIWidget {
    ...
    fn render(
        ...
        let mut row = Flex::row()
            ...
            .with_child(
                Text::new_inline(
                    t!("settings.ai.warp_agent").to_string(),
        ...
        if is_ai_disabled_due_to_remote_session_org_policy {
            row.add_child(
                ConstrainedBox::new(
                    Container::new(
                        Text::new(
                            t!("settings.ai.remote_session_org_policy").to_string(),
                            appearance.ui_font_family(),
                            12.,
                        )
            ...
            row.add_child(
                Flex::row()
                    ...
                    .with_child(
                        Container::new(
                            Text::new_inline(
                                t!("settings.ai.sign_up_prompt").to_string(),
                                appearance.ui_font_family(),
                                14.,
                            )
                            .with_color(
...
impl UsageWidget {
    fn render_request_usage_count(
        ...
        let request_count_label = if workspace_is_delinquent_due_to_payment_issue {
            t!("settings_extra.ai.restricted_billing_issue").to_string()
        } else if is_unlimited {
            t!("settings_extra.ai.unlimited").to_string()
        } else {
            format!("{used}/{limit}")
        };
...
impl SettingsWidget for UsageWidget {
    ...
    fn render(
        ...
        let formatted_next_refresh_time = format_localized_datetime(
            next_refresh_time.with_timezone(&Local),
            ...
            Flex::row()
                ...
                .with_child(
                    appearance
                        ...
                        .paragraph(
                            t!(
                                "settings_extra.ai.usage_resets",
                                name = formatted_next_refresh_time
                            )
                            .to_string(),
                        )
                        .with_style(UiComponentStyles {
        ...
        let refresh_duration = match ai_request_usage_model.refresh_duration_to_string().as_str() {
            "weekly" => t!("settings_extra.ai.weekly").to_string(),
            "monthly" => t!("settings_extra.ai.monthly").to_string(),
            "biweekly" => t!("settings_extra.ai.biweekly").to_string(),
            name => name.to_string(),
        };
        let request_limit_description = t!(
            "settings_extra.ai.credit_limit_description",
            name = refresh_duration
        )
        .to_string();

        let request_usage_row = self.render_ai_usage_limit_row(
            t!("settings_extra.ai.credits"),
                    ...
                    if has_admin_permissions {
                        vec![
                            FormattedTextFragment::hyperlink(
                                t!("settings_extra.ai.upgrade").to_string(),
                                upgrade_url,
                            ),
                            FormattedTextFragment::plain_text(
                                t!("settings_extra.ai.to_get_more_usage").to_string(),
                            ),
                        ]
                    } else {
                        ...
                        vec![
                            ...
                            FormattedTextFragment::plain_text(
                                t!("settings_extra.ai.for_more_usage").to_string(),
                            ),
                        ]
                    }
                } else {
...
impl ActiveAIWidget {
        ...
        Flex::column()
            .with_child(
                render_ai_setting_toggle::<IntelligentAutosuggestionsEnabled>(
                    t!("settings.ai.active_ai.next_command").to_string(),
                    AISettingsPageAction::ToggleIntelligentAutosuggestions,
            ...
            .with_child(render_ai_setting_description(
                t!("settings.ai.active_ai.next_command_description").to_string(),
                is_toggleable,
                app,
            ))
            .finish()
        ...
        Flex::column()
            .with_child(
                render_ai_setting_toggle::<AgentModeQuerySuggestionsEnabled>(
                    t!("settings.ai.active_ai.prompt_suggestions").to_string(),
                    AISettingsPageAction::TogglePromptSuggestions,
            ...
            .with_child(render_ai_setting_description(
                t!("settings.ai.active_ai.prompt_suggestions_description").to_string(),
                is_toggleable,
                app,
            ))
            .finish()
    ...
    fn render_suggested_code_banners_section(
        ...
        Flex::column()
            .with_child(
                render_ai_setting_toggle::<AgentModeQuerySuggestionsEnabled>(
                    t!("settings.ai.active_ai.suggested_code_banners").to_string(),
                    AISettingsPageAction::ToggleCodeSuggestions,
            ...
            .with_child(render_ai_setting_description(
                t!("settings.ai.active_ai.suggested_code_banners_description").to_string(),
                is_toggleable,
                app,
            ))
            .finish()
    ...
    fn render_natural_language_autosuggestions_section(
        ...
        Flex::column()
            ...
            >(
                t!("settings.ai.active_ai.natural_language_autosuggestions").to_string(),
                AISettingsPageAction::ToggleNaturalLanguageAutosuggestions,
            ...
            .with_child(render_ai_setting_description(
                t!("settings.ai.active_ai.natural_language_autosuggestions_description")
                    .to_string(),
                is_toggleable,
                app,
            ))
        ...
        Flex::column()
            .with_child(
                render_ai_setting_toggle::<SharedBlockTitleGenerationEnabled>(
                    t!("settings.ai.active_ai.shared_block_title_generation").to_string(),
                    AISettingsPageAction::ToggleSharedTitleGeneration,
            ...
            .with_child(render_ai_setting_description(
                t!("settings.ai.active_ai.shared_block_title_generation_description").to_string(),
                is_toggleable,
                app,
            ))
            .finish()
    ...
    fn render_git_operations_autogen_section(
        ...
        Flex::column()
            .with_child(render_ai_setting_toggle::<GitOperationsAutogenEnabled>(
                t!("settings.ai.active_ai.commit_pr_generation").to_string(),
                AISettingsPageAction::ToggleGitOperationsAutogen,
            ...
            .with_child(render_ai_setting_description(
                t!("settings.ai.active_ai.commit_pr_generation_description").to_string(),
                is_toggleable,
                app,
            ))
            .finish()
    ...
    fn render(
        ...
        if FeatureFlag::ProfilesDesignRevamp.is_enabled() {
            ...
            agents_header.add_child(
                build_sub_header(
                    appearance,
                    t!("settings.ai.agents.title").to_string(),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
            ...
            agents_header.add_child(render_ai_setting_description(
                t!("settings.ai.agents.description").to_string(),
                ai_settings.is_any_ai_enabled(app),
                app,
            ));
...
impl AgentsWidget {
    fn render_profiles_section(
        ...
        let header_and_description = Flex::column()
            .with_child(
                build_sub_header(
                    appearance,
                    t!("settings.ai.agents.profiles").to_string(),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .finish(),
            )
            .with_child(
                Container::new(render_ai_setting_description(
                    t!("settings.ai.agents.profiles_description").to_string(),
                    is_any_ai_enabled,
                    app,
                ))
                .with_margin_top(12.)
    ...
    fn render_context_window_setting(
        ...
        let label = Container::new(render_body_item_label::<AISettingsPageAction>(
            t!("settings.execution_profile.context_window_tokens").to_string(),
            None,
            None,
    ...
    fn render_permissions_section(
        ...
        let permissions_subheader = Container::new(render_custom_size_header(
            appearance,
            t!("settings.execution_profile.permissions").to_string(),
            14.0,
            Some(styles::header_font_color(is_any_ai_enabled, app)),
        ))
        .with_margin_bottom(4.0)
        ...
        let code_diffs = self.render_execution_profile_dropdown(
            t!("settings.execution_profile.apply_code_diffs_label").to_string(),
            Icon::Code2,
        ...
        read_files_flex.add_child(self.render_execution_profile_dropdown(
            t!("settings.execution_profile.read_files_label").to_string(),
            Icon::Notebook,
        ...
        execute_commands_flex.add_child(self.render_execution_profile_dropdown(
            t!("settings.execution_profile.execute_commands_label").to_string(),
            Icon::Terminal,
            ...
            .has_any_overrides()
        {
            widget_children.push(
                Container::new(render_settings_info_banner(
                    t!("settings.execution_profile.workspace_permissions_managed").to_string(),
                    None,
                    appearance,
                ))
                .with_margin_bottom(12.0)
        ...
        let write_to_pty = self.render_execution_profile_dropdown(
            t!("settings.execution_profile.interact_with_running_commands_label").to_string(),
            Icon::Workflow,
    ...
    fn render_execution_profile_dropdown(
        ...
        header_icon: Icon,
        permission_description: impl Into<String>,
    ...
    fn render_command_denylist(
        ...
        render_ai_list(
            t!("settings.execution_profile.command_denylist_label").to_string(),
            t!("settings.execution_profile.warp_agent_command_denylist_description").to_string(),
            list,
            view,
            ai_settings,
            app,
    ...
    fn render_command_allowlist(
        ...
        render_ai_list(
            t!("settings.execution_profile.command_allowlist_label").to_string(),
            t!("settings.execution_profile.warp_agent_command_allowlist_description").to_string(),
            list,
            view,
            ai_settings,
            app,
    ...
    fn render_directory_allowlist(
        ...
        render_ai_list(
            t!("settings.execution_profile.directory_allowlist_label").to_string(),
            t!("settings.execution_profile.directory_allowlist_description").to_string(),
            list,
            view,
            ai_settings,
            app,
    ...
    fn render_base_model_setting(
            ...
            Container::new(
                Flex::row()
                    ...
                    .with_children([
                        ...
                        appearance
                            .ui_builder()
                            .span(t!("settings_extra.ai.show_model_picker").to_string())
                            .with_style(UiComponentStyles {
                                font_color: Some(
        ...
        render_dropdown_item(
            appearance,
            t!("settings.execution_profile.base_model_label").to_string(),
            Some(t!("settings.execution_profile.warp_agent_base_model_description").as_ref()),
    ...
    fn render_codebase_context_outline_generation_setting(
        ...
        let toggle = render_ai_setting_toggle::<CodebaseContextEnabled>(
            t!("settings_extra.ai.codebase_context"),
            AISettingsPageAction::ToggleCodebaseContext,
        ...
        let codebase_context_description = vec![
            FormattedTextFragment::plain_text(
                t!("settings_extra.ai.codebase_context_description").to_string(),
            ),
            FormattedTextFragment::hyperlink(
    ...
    fn render_mcp_permissions_zero_state(
        ...
        let header = Container::new(render_body_item_label_with_icon::<AISettingsPageAction>(
            t!("settings.execution_profile.call_mcp_servers_label").to_string(),
            Icon::Dataflow,
            Some(styles::header_font_color(
                ai_settings.is_any_ai_enabled(app),
                app,
        ...
        let subtext = {
            let subtext_fragments = vec![
                FormattedTextFragment::plain_text(
                    t!("settings_extra.ai.mcp_zero_state_description").to_string(),
                ),
                FormattedTextFragment::hyperlink_action(
                    t!("settings_extra.ai.add_server").to_string(),
                    AISettingsPageAction::OpenMCPServerCollection,
                ),
                FormattedTextFragment::plain_text(t!("settings_extra.ai.or_separator").to_string()),
                FormattedTextFragment::hyperlink(
                    t!("settings_extra.ai.learn_more_about_mcp").to_string(),
    ...
    fn render_mcp_permissions_with_servers(
            ...
            || current_mcp_setting == ActionPermission::AgentDecides
        {
            let allowlist = self.render_mcp_list(
                t!("settings.execution_profile.mcp_allowlist_label").to_string(),
                t!("settings.execution_profile.warp_agent_mcp_allowlist_description").to_string(),
            ...
            || current_mcp_setting == ActionPermission::AgentDecides
        {
            let denylist = self.render_mcp_list(
                t!("settings.execution_profile.mcp_denylist_label").to_string(),
                t!("settings.execution_profile.warp_agent_mcp_denylist_description").to_string(),
...
impl SettingsWidget for AIInputWidget {
    ...
    fn render(
        ...
        let input_header = build_sub_header(
            appearance,
            t!("settings.ai.input.title").to_string(),
            Some(styles::header_font_color(is_any_ai_enabled, app)),
        )
        .with_padding_bottom(HEADER_PADDING)
        .finish();
        ...
        let show_input_hint_text = render_ai_setting_toggle::<ShowHintText>(
            t!("settings.ai.input.show_input_hint_text").to_string(),
            AISettingsPageAction::ToggleShowInputHintText,
        ...
        if FeatureFlag::AgentTips.is_enabled() {
            let agent_tips_toggle = render_ai_setting_toggle::<ShowAgentTips>(
                t!("settings.ai.input.show_agent_tips").to_string(),
                AISettingsPageAction::ToggleShowAgentTips,
        ...
        widget_children.push(render_ai_setting_toggle::<IncludeAgentCommandsInHistory>(
            t!("settings.ai.input.include_agent_commands_in_history").to_string(),
            AISettingsPageAction::ToggleIncludeAgentCommandsInHistory,
        ...
        if FeatureFlag::QueueSlashCommand.is_enabled() {
            let default_prompt_submission_mode_label =
                t!("settings.ai.input.default_prompt_submission_mode").to_string();
            let default_prompt_submission_mode_description =
                t!("settings.ai.input.default_prompt_submission_mode_description").to_string();
            widget_children.push(render_dropdown_item(
                appearance,
                &default_prompt_submission_mode_label,
                Some(&default_prompt_submission_mode_description),
                None,
                LocalOnlyIconState::for_setting(
            ...
            if ai_settings.default_prompt_submission_mode == PromptSubmissionMode::Interrupt {
                let default_lrc_submission_mode_label =
                    t!("settings.ai.input.default_lrc_submission_mode").to_string();
                let default_lrc_submission_mode_description =
                    t!("settings.ai.input.default_lrc_submission_mode_description").to_string();
                widget_children.push(
                    Container::new(render_dropdown_item(
                        appearance,
                        &default_lrc_submission_mode_label,
                        Some(&default_lrc_submission_mode_description),
                        None,
                        LocalOnlyIconState::for_setting(
    ...
    fn render_natural_language_detection_section(
        ...
        if FeatureFlag::AgentView.is_enabled() {
            let autodetection_description_fragments = vec![
                FormattedTextFragment::plain_text(
                    t!("settings.ai.input.incorrect_detection_prompt").to_string(),
                ),
                FormattedTextFragment::hyperlink(
                    t!("settings.ai.input.let_us_know").to_string(),
            ...
            section.add_children([
                render_ai_setting_toggle::<NLDInTerminalEnabled>(
                    t!("settings.ai.input.autodetect_agent_prompts").to_string(),
                    AISettingsPageAction::ToggleNLDInTerminal,
                ...
                render_ai_setting_toggle::<AIAutoDetectionEnabled>(
                    t!("settings.ai.input.autodetect_terminal_commands").to_string(),
                    AISettingsPageAction::ToggleAIInputAutoDetection,
                    is_nld_enabled,
                    is_toggleable,
            ...
            let natural_language_detection_description_fragments = vec![
                FormattedTextFragment::plain_text(
                    t!("settings.ai.input.natural_language_detection_description").to_string(),
                ),
                FormattedTextFragment::plain_text(
                    t!("settings.ai.input.incorrect_input_detection_prompt").to_string(),
                ),
                FormattedTextFragment::hyperlink(
                    t!("settings.ai.input.let_us_know").to_string(),
                    "https://warpdotdev.typeform.com/to/offrTIpq",
            ...
            section.add_children([
                render_ai_setting_toggle::<AIAutoDetectionEnabled>(
                    t!("settings.ai.input.natural_language_detection").to_string(),
                    AISettingsPageAction::ToggleAIInputAutoDetection,
                    is_nld_enabled,
                    is_toggleable,
                    autodetection_toggle,
        ...
        section
            .with_child(render_ai_setting_label::<AICommandDenylist>(
                t!("settings.ai.input.natural_language_denylist").to_string(),
                is_toggleable,
                &view.local_only_icon_tooltip_states,
                app,
            ))
            .with_child(render_ai_setting_description(
                t!("settings.ai.input.natural_language_denylist_description").to_string(),
                is_toggleable,
                app,
            ))
            .with_child(
...
impl SettingsWidget for MCPServersWidget {
    ...
    fn render(
        ...
        let header = build_sub_header(
            appearance,
            t!("settings.ai.mcp_servers.title"),
            Some(styles::header_font_color(is_any_ai_enabled, app)),
        )
        .with_padding_bottom(HEADER_PADDING)
        .finish();
        ...
        let mcp_description = vec![
            FormattedTextFragment::plain_text(
                t!("settings.ai.mcp_servers.description").to_string(),
            ),
            FormattedTextFragment::hyperlink(
                t!("common.learn_more").to_string(),
                "https://docs.warp.dev/agent-platform/capabilities/mcp",
                ...
                Flex::column()
                    ...
                    .with_child({
                        let file_based_mcp_description_fragments = vec![
                            FormattedTextFragment::plain_text(
                                t!("settings.ai.mcp_servers.auto_spawn_description").to_string(),
                            ),
                            FormattedTextFragment::hyperlink(
        ...
        let button = render_full_pane_width_ai_button(
            t!("settings.ai.mcp_servers.manage"),
            is_any_ai_enabled,
...
impl AIFactWidget {
    fn render_rules_toggle(
        ...
        let rules_description = vec![
            FormattedTextFragment::plain_text(
                t!("settings.ai.knowledge.rules_description").to_string(),
            ),
            FormattedTextFragment::hyperlink(
                t!("common.learn_more").to_string(),
    ...
    fn render_rule_suggestions_toggle(
        ...
        let description = render_ai_setting_description(
            t!("settings.ai.knowledge.suggested_rules_description"),
            ai_settings.is_any_ai_enabled(app),
            app,
        );
    ...
    fn render_warp_drive_context_toggle(
        ...
        let description = render_ai_setting_description(
            t!("settings.ai.knowledge.warp_drive_context_description"),
            ai_settings.is_any_ai_enabled(app),
            app,
        );
...
impl SettingsWidget for AIFactWidget {
    ...
    fn render(
        ...
        let button = render_full_pane_width_ai_button(
            t!("settings.ai.knowledge.manage_rules"),
            is_any_ai_enabled,
...
impl VoiceWidget {
    fn render_voice_section(
        ...
        let voice_input_description_text_fragments = vec![
            FormattedTextFragment::plain_text(
                t!("settings.ai.voice.input_description_prefix").to_string(),
            ),
            FormattedTextFragment::hyperlink("Wispr Flow", WISPR_FLOW_URL),
            FormattedTextFragment::plain_text(
                t!("settings.ai.voice.input_description_suffix").to_string(),
            ),
        ];
        ...
        if ai_settings.is_voice_input_enabled(app) {
            let activation_key_description =
                t!("settings.ai.voice.activation_key_description").to_string();
            column.add_child(render_dropdown_item(
                appearance,
                t!("settings.ai.voice.activation_key"),
                Some(activation_key_description.as_str()),
                None,
                LocalOnlyIconState::for_setting(
...
impl SettingsWidget for OtherAIWidget {
    ...
    fn render(
        ...
        if FeatureFlag::AgentView.is_enabled() {
            let mut agent_view_column = Flex::column()
                .with_child(render_ai_setting_toggle::<ShouldShowOzUpdatesInZeroState>(
                    t!("settings.ai.other.show_oz_changelog"),
                    AISettingsPageAction::ToggleShowOzUpdatesInZeroState,
                ...
                >(
                    t!("settings.ai.other.show_use_agent_footer"),
                    AISettingsPageAction::ToggleUseAgentToolbar,
                ...
                .with_child(render_ai_setting_description(
                    t!("settings.ai.other.show_use_agent_footer_description"),
                    is_toggleable,
                    app,
                ));
        ...
        column.add_child(render_ai_setting_toggle::<ShowConversationHistory>(
            t!("settings.ai.other.show_conversation_history"),
            AISettingsPageAction::ToggleShowConversationHistory,
        ...
        let agent_thinking_description =
            t!("settings.ai.other.agent_thinking_display_description").to_string();
        column.add_child(render_dropdown_item(
            appearance,
            t!("settings.ai.other.agent_thinking_display"),
            Some(agent_thinking_description.as_str()),
            None,
            LocalOnlyIconState::for_setting(
        ...
        let orchestration_message_description =
            t!("settings.ai.other.orchestration_message_display_description").to_string();
        column.add_child(render_dropdown_item(
            appearance,
            t!("settings.ai.other.orchestration_message_display"),
            Some(orchestration_message_description.as_str()),
            None,
            LocalOnlyIconState::for_setting(
        ...
        if FeatureFlag::OpenWarpNewSettingsModes.is_enabled() {
            ...
            column.add_child(render_dropdown_item(
                appearance,
                t!("settings.ai.other.preferred_existing_conversation_layout"),
                None,
                None,
                LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CLIAgentWidget {
    ...
    fn render(
        ...
        let cli_agent_footer_toggle = render_ai_setting_toggle::<ShouldRenderCLIAgentToolbar>(
            t!("settings.ai.third_party_cli_agents.show_toolbar"),
            AISettingsPageAction::ToggleCLIAgentToolbar,
        ...
        let description_fragments = vec![
            FormattedTextFragment::plain_text(
                t!("settings.ai.third_party_cli_agents.description_prefix").to_string(),
            ),
            FormattedTextFragment::inline_code("claude"),
            FormattedTextFragment::plain_text(t!("settings_extra.ai.list_separator").to_string()),
            FormattedTextFragment::inline_code("codex"),
            FormattedTextFragment::plain_text(
                t!("settings_extra.ai.list_final_separator").to_string(),
            ),
            FormattedTextFragment::inline_code("gemini"),
            FormattedTextFragment::plain_text(t!("settings_extra.ai.sentence_period").to_string()),
        ];
        ...
        let mut column = Flex::column()
            .with_child(
                build_sub_header(
                    appearance,
                    t!("settings.ai.third_party_cli_agents.title"),
                    Some(styles::header_font_color(true, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
        ...
        if is_footer_enabled {
            ...
            if FeatureFlag::CLIAgentRichInput.is_enabled() {
                ...
                let auto_show_toggle_label = render_body_item_label::<AISettingsPageAction>(
                    t!("settings.ai.third_party_cli_agents.auto_toggle_rich_input").to_string(),
                    Some(styles::header_font_color(true, app)),
                    Some(AdditionalInfo {
                        ...
                        tooltip_override_text: Some(
                            t!("settings.ai.third_party_cli_agents.requires_warp_plugin")
                                .to_string(),
                        ),
                    }),
                    LocalOnlyIconState::for_setting(
                ...
                column.add_child(
                    render_ai_setting_toggle::<AutoOpenRichInputOnCLIAgentStart>(
                        t!("settings.ai.third_party_cli_agents.auto_open_rich_input"),
                        AISettingsPageAction::ToggleAutoOpenRichInputOnCLIAgentStart,
                ...
                column.add_child(render_ai_setting_toggle::<AutoDismissRichInputAfterSubmit>(
                    t!("settings.ai.third_party_cli_agents.auto_dismiss_rich_input"),
                    AISettingsPageAction::ToggleAutoDismissRichInputAfterSubmit,
                ...
                column.add_child(render_ai_setting_toggle::<SubmitRichInputOnCtrlEnter>(
                    t!("settings.ai.third_party_cli_agents.submit_rich_input_ctrl_enter"),
                    AISettingsPageAction::ToggleSubmitRichInputOnCtrlEnter,
            ...
            let command_list = {
                ...
                list_column.add_child(
                    appearance
                        .ui_builder()
                        .span(
                            t!("settings.ai.third_party_cli_agents.commands_enable_toolbar")
                                .to_string(),
                        )
                        .with_style(UiComponentStyles {
                            font_size: Some(CONTENT_FONT_SIZE),
            ...
            let command_list_description = appearance
                .ui_builder()
                .paragraph(t!(
                    "settings.ai.third_party_cli_agents.command_patterns_description"
                ))
                .with_style(UiComponentStyles {
                    font_size: Some(appearance.ui_font_size()),
...
impl SettingsWidget for AgentAttributionWidget {
    ...
    fn render(
        ...
        let toggle = if state.is_forced_by_org {
            ui_builder
                ...
                .with_tooltip(TooltipConfig {
                    text: t!("settings_extra.ai.organization_enforced_tooltip").to_string(),
        ...
        let toggle_row = build_toggle_element(
            render_body_item_label::<AISettingsPageAction>(
                t!("settings_extra.ai.enable_agent_attribution").to_string(),
        ...
        Flex::column()
            ...
            .with_child(
                build_sub_header(
                    appearance,
                    t!("settings_extra.ai.agent_attribution"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
            ...
            .with_child(render_ai_setting_description(
                t!("settings_extra.ai.agent_attribution_description"),
                !state.is_disabled,
                app,
            ))
            .finish()
...
impl SettingsWidget for CloudAgentComputerUseWidget {
    ...
    fn render(
        ...
        let toggle_row = build_toggle_element(
            render_body_item_label::<AISettingsPageAction>(
                t!("settings_extra.ai.cloud_agent_computer_use").to_string(),
        ...
        Flex::column()
            ...
            .with_child(
                build_sub_header(
                    appearance,
                    t!("settings_extra.ai.experimental"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
            ...
            .with_child(toggle_row)
            .with_child(render_ai_setting_description(
                t!("settings_extra.ai.cloud_agent_computer_use_description"),
                !is_disabled,
                app,
            ))
            .finish()
...
impl SettingsWidget for CloudHandoffWidget {
    ...
    fn render(
        ...
        let tooltip_text = if cloud_convos_off {
            t!("settings.ai.cloud_handoff.requires_cloud_conversations").to_string()
        } else {
            String::new()
        };
        ...
        let handoff_row = build_toggle_element(
            render_body_item_label::<AISettingsPageAction>(
                t!("settings.ai.cloud_handoff.toggle").to_string(),
        ...
        let mut column = Flex::column()
            ...
            .with_child(
                build_sub_header(
                    appearance,
                    t!("settings.ai.cloud_handoff.title"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
            ...
            .with_child(render_ai_setting_description(
                t!("settings.ai.cloud_handoff.description"),
                !is_force_disabled,
                app,
            ));
        ...
        if ai_settings.is_cloud_handoff_enabled(app) {
                ...
                .is_supported_on_current_platform()
            {
                ...
                let auto_handoff_on_sleep_row = build_toggle_element(
                    render_body_item_label::<AISettingsPageAction>(
                        t!("settings.ai.cloud_handoff.auto_before_sleep").to_string(),
                        Some(styles::header_font_color(true, app)),
                        None,
                        LocalOnlyIconState::Hidden,
                        ToggleState::Enabled,
                ...
                column.add_child(render_ai_setting_description(
                    t!("settings.ai.cloud_handoff.auto_before_sleep_description"),
                    true,
                    app,
                ));
            }
            ...
            let ampersand_row = build_toggle_element(
                render_body_item_label::<AISettingsPageAction>(
                    t!("settings.ai.cloud_handoff.use_ampersand").to_string(),
                    Some(styles::header_font_color(true, app)),
                    None,
                    LocalOnlyIconState::Hidden,
                    ToggleState::Enabled,
            ...
            column.add_child(render_ai_setting_description(
                t!("settings.ai.cloud_handoff.use_ampersand_description"),
                true,
                app,
            ));
        }
...
impl ApiKeysWidget {
    fn new(ctx: &mut ViewContext<<Self as SettingsWidget>::View>) -> Self {
        ...
        let grok_connect_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(
                t!("settings.ai.buttons.connect").to_string(),
                SecondaryTheme,
            )
            .with_size(ButtonSize::Small)
            .on_click(|ctx| {
        ...
        let grok_connecting_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(
                t!("settings.ai.buttons.connecting").to_string(),
                SecondaryTheme,
            )
            .with_size(ButtonSize::Small)
        });
        ...
        let grok_disconnect_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(
                t!("settings.ai.buttons.disconnect").to_string(),
    ...
    fn render_team_key_info_icon(
        ...
        let tooltip_text = FormattedText::new([FormattedTextLine::Line(vec![
            FormattedTextFragment::plain_text(
                t!(
                    "settings_extra.ai.organization_api_key_tooltip",
                    name = provider_name
                )
                .to_string(),
            ),
    ...
    fn render_provider_key_editors(
        ...
        column.add_child(self.render_api_key_input(
            appearance,
            t!("settings_extra.ai.openai_api_key").to_string(),
            LLMProvider::OpenAI,
        ...
        column.add_child(self.render_api_key_input(
            appearance,
            t!("settings_extra.ai.anthropic_api_key").to_string(),
            LLMProvider::Anthropic,
        ...
        column.add_child(self.render_api_key_input(
            appearance,
            t!("settings_extra.ai.google_api_key").to_string(),
            LLMProvider::Google,
    ...
    fn render_custom_inference_description(
        ...
        if show_provider_keys {
            add_paragraph(vec![FormattedTextFragment::plain_text(
                t!("settings.ai.custom_inference.provider_keys_description").to_string(),
            )]);
        }

        if show_custom_endpoints {
            add_paragraph(vec![FormattedTextFragment::plain_text(
                t!("settings.ai.custom_inference.custom_endpoints_description").to_string(),
            )]);
        }

        if show_provider_keys || show_custom_endpoints {
            add_paragraph(vec![FormattedTextFragment::plain_text(
                t!("settings.ai.custom_inference.local_storage_note").to_string(),
            )]);
    ...
    fn render_custom_inference_info_icon(
        ...
        let tooltip_text = if managed_byok_byoe_enabled {
            FormattedText::new([FormattedTextLine::Line(vec![
                FormattedTextFragment::plain_text(
                    t!("settings.ai.custom_inference.managed_by_org_tooltip").to_string(),
                ),
            ])])
        } else {
            FormattedText::new([FormattedTextLine::Line(vec![
                FormattedTextFragment::plain_text(
                    t!("settings.ai.custom_inference.terms_prefix").to_string(),
                ),
                FormattedTextFragment::hyperlink(
                    t!("settings.ai.custom_inference.terms_link").to_string(),
                    CUSTOM_INFERENCE_TERMS_URL,
                ),
                FormattedTextFragment::plain_text(
                    t!("settings.ai.custom_inference.terms_suffix").to_string(),
                ),
            ])])
        };
        let tooltip_background = appearance.theme().tooltip_background();
    ...
    fn render_grok_subscription_row(
        ...
        let label = Flex::row()
            ...
            .with_child(
                Text::new_inline(
                    t!("settings.ai.grok.use_your").to_string(),
                    appearance.ui_font_family(),
                    CONTENT_FONT_SIZE,
                )
                .with_color(text_color.into())
            ...
            .with_child(
                Text::new_inline(
                    t!("settings.ai.grok.premium_or_supergrok_subscription").to_string(),
                    appearance.ui_font_family(),
                    CONTENT_FONT_SIZE,
                )
                .with_color(text_color.into())
        ...
        let description = Container::new(
            Text::new(
                t!("settings.ai.grok.description"),
                appearance.ui_font_family(),
                CONTENT_FONT_SIZE,
            )
        ...
        if let Some(tokens) = grok_tokens {
            let connected_text = match tokens.connected_at.map(DateTime::<Local>::from) {
                Some(connected_at) => format!(
                    "{} {}.",
                    t!("settings.ai.grok.connected_on"),
                    format_localized_datetime(connected_at, LocalizedDateTimeFormat::ShortDateTime)
                ),
                // Tokens stored before the connection time was tracked.
                None => t!("settings.ai.grok.connected").to_string(),
            };
    ...
    fn render_warp_credit_fallback_toggle(
        ...
        let description = render_ai_setting_description(
            t!("settings.ai.custom_inference.warp_credit_fallback_description"),
            ai_settings.is_any_ai_enabled(app),
            app,
        );
        ...
        if visibility.show_section() {
            ...
            let header_left = Flex::row()
                ...
                .with_child(
                    build_sub_header(
                        appearance,
                        t!("settings.ai.custom_inference.title"),
            ...
            column.add_child(render_ai_setting_description(
                t!("settings.ai.custom_inference.managed_by_org_description"),
                is_any_ai_enabled,
                app,
            ));
        } else {
            ...
            column.add_child(
                build_sub_header(
                    appearance,
                    t!("settings.ai.custom_inference.api_keys"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
        ...
        if show_custom_inference {
            ...
            if !endpoints.is_empty() {
                column.add_child(
                    Container::new(
                        Text::new_inline(
                            t!("settings_extra.ai.custom_endpoints").to_string(),
                            appearance.ui_font_family(),
                            CONTENT_FONT_SIZE,
                        )
                        .with_color(
            ...
            let upgrade_text_fragments =
                if let Some(team) = UserWorkspaces::as_ref(app).current_team() {
                    if team.billing_metadata.customer_type == CustomerType::Enterprise {
                        vec![
                            FormattedTextFragment::hyperlink(
                                t!("settings_extra.ai.contact_sales").to_string(),
                                "mailto:sales@warp.dev",
                            ),
                            FormattedTextFragment::plain_text(
                                t!("settings_extra.ai.enable_own_api_keys_enterprise").to_string(),
                            ),
                        ]
                    } else {
                        let current_user_email = auth_state.user_email().unwrap_or_default();
                        ...
                        if has_admin_permissions {
                            vec![
                                FormattedTextFragment::hyperlink(
                                    t!("settings_extra.ai.upgrade_build_plan").to_string(),
                                    upgrade_url,
                                ),
                                FormattedTextFragment::plain_text(
                                    t!("settings_extra.ai.use_own_api_keys_suffix").to_string(),
                                ),
                            ]
                        } else {
                            vec![FormattedTextFragment::plain_text(
                                t!("settings_extra.ai.ask_admin_upgrade_for_api_keys").to_string(),
                            )]
                        }
                    }
                    ...
                    && auth_state.is_anonymous_or_logged_out()
                {
                    vec![
                        FormattedTextFragment::hyperlink_action(
                            t!("settings_extra.ai.create_account").to_string(),
                            AISettingsPageAction::SignupAnonymousUser,
                        ),
                        FormattedTextFragment::plain_text(
                            t!("settings_extra.ai.use_own_api_keys_suffix").to_string(),
...
impl AwsBedrockWidget {
    fn new(ctx: &mut ViewContext<<Self as SettingsWidget>::View>) -> Self {
        ...
        let refresh_credentials_button = ctx.add_typed_action_view(|_| {
            ActionButton::new(
                t!("settings.ai.buttons.refresh").to_string(),
                SecondaryTheme,
            )
    ...
    fn render_aws_bedrock_section(
        ...
        let toggle_description = if is_admin_enforced {
            t!("settings_extra.ai.aws_bedrock_credentials_managed").to_string()
        } else {
            t!("settings_extra.ai.aws_bedrock_credentials_description").to_string()
        };

        let mut column = Flex::column().with_spacing(16.).with_child(
            Flex::column()
                .with_child(render_ai_setting_toggle::<AwsBedrockCredentialsEnabled>(
                    t!("settings_extra.ai.use_aws_bedrock_credentials"),
                    AISettingsPageAction::ToggleAwsBedrockCredentialsEnabled,
        ...
        column.add_child(render_input(
            appearance,
            t!("settings_extra.ai.login_command").to_string(),
        ...
        column.add_child(render_input(
            appearance,
            t!("settings_extra.ai.aws_profile").to_string(),
        ...
        let toggle = render_ai_setting_toggle::<AwsBedrockAutoLogin>(
            t!("settings_extra.ai.auto_run_login_command"),
            AISettingsPageAction::ToggleAwsBedrockAutoLogin,
            auto_login_enabled,
            is_usage_enabled,
        ...
        let description = render_ai_setting_description(
            t!("settings_extra.ai.auto_run_login_command_description"),
            is_usage_enabled,
            app,
        );
        column.add_child(
    ...
    fn render(
        ...
        let column = Flex::column()
            ...
            .with_child(
                build_sub_header(
                    appearance,
                    t!("settings_extra.ai.aws_bedrock"),
                    Some(styles::header_font_color(is_any_ai_enabled, app)),
                )
                .with_padding_bottom(HEADER_PADDING)
                .finish(),
    ...
    fn render(
        ...
        let header_row = Flex::row()
            ...
            .with_child(
                build_sub_header(
                    appearance,
                    t!("settings_extra.ai.custom_routers"),
                    Some(header_color),
                )
                .finish(),
            )
        ...
        let column = Flex::column()
            ...
            .with_child(render_ai_setting_description(
                t!("settings_extra.ai.custom_routers_description"),
                is_any_ai_enabled,
                app,
            ));
