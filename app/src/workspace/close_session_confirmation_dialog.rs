...
impl View for CloseSessionConfirmationDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let dont_show_again_checkbox = appearance
            ...
            .with_label(Span::new(
                t!("workspace.close_session.dont_show_again").to_string(),
                Default::default(),
            ))
        ...
        let close_session_button = appearance
            ...
            .with_centered_text_label(t!("workspace.close_session.close_session").to_string())
        ...
        let dialog = Container::new(
            Dialog::new(
                t!("workspace.close_session.title").to_string(),
                Some(t!("workspace.close_session.description").to_string()),
                UiComponentStyles {
                    width: Some(460.),
