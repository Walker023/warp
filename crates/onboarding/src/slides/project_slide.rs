...
impl ProjectSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        let title = appearance
            .ui_builder()
            .paragraph(t!("onboarding.project.title").to_string())
        ...
        let subtitle = appearance
            .ui_builder()
            .paragraph(t!("onboarding.project.subtitle").to_string())
            .with_style(UiComponentStyles {
                font_size: Some(20.),
        ...
        let (label, variant) = match settings {
            ...
            ProjectOnboardingSettings::NoProject => {
                ...
                let folder_text = Container::new(
                    appearance
                        .ui_builder()
                        .paragraph(t!("onboarding.project.open_local_folder").to_string())
                        .with_style(UiComponentStyles {
                            font_color: Some(text_color),
                            ..Default::default()
                        })
    ...
    fn render_bottom_nav(
        ...
        let (label, keystroke, action) = match settings {
            ...
            ProjectOnboardingSettings::NoProject => (
                t!("onboarding.common.skip").to_string(),
    ...
    fn render_project_options(
        ...
        let initialize = self.render_option(
            ...
            initialize_projects_automatically,
            t!("onboarding.project.initialize_auto.title").to_string(),
            t!("onboarding.project.initialize_auto.description").to_string(),
